...
clean:
	rm -f $(MANDEL_EXEC) $(MANDEL_MPI_EXEC) $(MANDEL_MPI2_EXEC) \
	      $(MANDEL_MPI3_EXEC) $(MANDEL_OMP_STATIC_EXEC) $(MANDEL_OMP_DYNAMIC_EXEC) \
	      $(COMMON_SRC:.c=.o) $(MANDEL_SRC:.c=.o) $(MANDEL_MPI_SRC:.c=.o) \
	      $(MANDEL_MPI2_SRC:.c=.o) *.ppm


.PHONY: all clean run run_mandel run_mandel_mpi run_mandel_mpi2 run_mandel_omp_static run_mandel_omp_dynamic run_mandel_mpi3
